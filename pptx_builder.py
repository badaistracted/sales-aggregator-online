...
def build_pptx(
    ...
    pct_summary_data — parsed result from parse_percentage_summary()
                       (or None if not uploaded)
    """
    prs = Presentation()
